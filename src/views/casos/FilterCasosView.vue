      ...
      <div class="column is-three-fifths">
        ...
        <div class="card">
          <header class="card-header">
            <p class="card-header-title is-centered">Casos</p>
          </header>
                            ...
                            <div class="column">
                              <div class="columns" v-for="agr in lstAgravo" :key="agr.id">
                                <label for="" class="radio">
                                  <input type="radio" name="agravo" v-model="filter.agravo" :value="agr.id">
                                  {{ agr.nome }}
                                </label>
                              </div>
                            </div>
                            ...
                            <div class="column">
                              <div class="columns" v-for="res in lstResult" :key="res.id">
                                <label for="" class="checkbox">
                                  <input type="checkbox" v-model="filter.status" :true-value="[]" :value="res.id">
                                  {{ res.nome }}
                                </label>
                              </div>
                            </div>
              ...
              <section class="section">
                <div class="columns is-centered">
                  <div class="column is-4">
                    <div class="control">
                      <button class="button is-link submit-btn is-fullwidth" id="login" @click="doProcessar">
